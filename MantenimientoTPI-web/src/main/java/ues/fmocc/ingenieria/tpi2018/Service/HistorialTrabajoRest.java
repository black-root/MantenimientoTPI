...
public class HistorialTrabajoRest implements Serializable {
    ...
    public Response remove(@PathParam("id") Integer id) {
        if (ejbHistorialTrabajo.eliminar(ejbHistorialTrabajo.find(id))) {
    ...
    @Path("crea")
    public Response create(HistorialTrabajo entity) {
        if (ejbHistorialTrabajo.crear(entity)) {
    ...
    @Path("editar")
    @Consumes(MediaType.APPLICATION_JSON)
    public Response edit(HistorialTrabajo entity) {
        if (ejbHistorialTrabajo.modificar(entity)) {
